...
void generate_lucky_statistics(int process_number, int process_count) {
  ...
  std::cout << "Process " << process_number + 1 << ": my lucky number is "
  ...
  if (process_number == 0) {
    ...
    std::cout << "All minimum = " << all_min << std::endl;
    std::cout << "All average = " << all_average << std::endl;
    std::cout << "All maximum = " << all_max << std::endl;
  }
}
